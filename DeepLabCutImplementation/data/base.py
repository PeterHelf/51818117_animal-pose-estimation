...
from DeepLabCutImplementation.data.dataset import (
    PoseDataset,
    PoseDatasetParameters,
)
from DeepLabCutImplementation.data.generative_sampling import (
    GenSamplingConfig,
)
from DeepLabCutImplementation.data.snapshots import list_snapshots, Snapshot
from DeepLabCutImplementation.data.utils import (
    ...
    def create_dataset(
        ...
        if self.pose_task == Task.COND_TOP_DOWN:
            ctd_config = GenSamplingConfig(
                bbox_margin=25,#self.model_cfg["data"].get("bbox_margin", 20),
