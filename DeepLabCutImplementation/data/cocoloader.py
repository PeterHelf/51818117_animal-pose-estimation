...
from DeepLabCutImplementation.data.base import Loader
from DeepLabCutImplementation.data.dataset import PoseDatasetParameters
from DeepLabCutImplementation.data.utils import map_id_to_annotations, map_image_path_to_id

class COCOLoader(Loader):
    """
    Attributes:
        project_root: root directory path of the COCO project.
        data_config: dict for the data configuration.
    ...
    def __init__(
        ...
        super().__init__(project_root, image_root, data_config)
    ...
    def get_dataset_parameters(self) -> PoseDatasetParameters:
        ...
        if self._dataset_parameters is None:
            ...
            crop_cfg = self.data_config["train"].get("top_down_crop", {})
            ...
            self._dataset_parameters = PoseDatasetParameters(
                ...
                with_center_keypoints=False,#self.model_cfg.get(
                #    "with_center_keypoints", False
                #),
                color_mode=self.data_config["colormode"],#.model_cfg.get("color_mode", "RGB"),
